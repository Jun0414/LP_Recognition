...
parser.add_argument("-i", "--img_dir", help="save image directory",
                    type=str, default="C:\\Users\Geon Yeol\Desktop\\20-1\capstone"
                                      "\capstone_github\CRNN\DB\\test\\")
...
print("start")
A.Type_1(300, save=Save)
print("Type 1 finish")
A.Type_2(300, save=Save)
print("Type 2 finish")